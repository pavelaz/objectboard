...
<head>
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        function nuevo_usuario(){
            ...
            document.forma.action = '/objectboard/country';
...
<div id="pcoded" class="pcoded">
    ...
    <div class="pcoded-container navbar-wrapper">
        ...
        <div class="pcoded-main-container">
            <!--start ############################### page-header ###############################-->
            <jstl:set var="jsp_titleFrom" scope="page" value="Country List Form"/>
                ...
                <form class="user" role="form" method="post" action="#!" name="forma" >
                    ...
                    >
                        ...
                        <tr>
                            ...
                            <th data-field="action" data-sortable="false" data-valign="middle" data-align="center">ACTION</th>
                        </tr>
                        </thead>
                        <tbody>
                        ...
                        <jstl:forEach var="x" begin="0" end="${ rq_numFilas -1 }" step="1">
                            ...
                            <tr>
                                <td><input type='checkbox' id="p_select" name='p_selec_<jstl:out value="${ f }"/>' /></td>
                                <td><jstl:out value="${ Math.toIntExact(rq_paises.get(x).getCoCountryCode()) }">Lost Value</jstl:out></td>
                                <td>
                                    <jstl:out value="${ rq_paises.get(x).getCoName() }">Lost Value</jstl:out>
                                    <input type='hidden' value='<jstl:out value="${ Math.toIntExact(rq_paises.get(x).getCoCountryCode()) }"/>'
                                           name='p_cual_<jstl:out value="${ f }"/>' />&nbsp;
                                </td>
                                <td>
                                    <a href='#' title="Edit" onClick=valida('<jstl:out value="${ Math.toIntExact(rq_paises.get(x).getCoCountryCode()) }"/>')>
