...
<head>
    ...
    <script type="text/javascript">
        ...
        function Validaciones(){
            if (!valida_textos(document.forma.p_name.value,"State's name","")||
                !valida_largos(document.forma.p_name.value.length,"State's name",3)||
...
<div id="pcoded" class="pcoded">
    ...
    <div class="pcoded-container navbar-wrapper">
        ...
        <jstl:set var="jsp_pagePrevious" scope="page" value="/objectboard/states"/>
        ...
        <div class="pcoded-main-container">
            <div class="pcoded-wrapper">
                <div class="pcoded-content">
                    ...
                    <!--start ############################### page-header ###############################-->
                    <jstl:set var="jsp_titleFrom" scope="page" value="State Maintenance Form"/>
                                                        ...
                                                        <jstl:choose>
                                                            <jstl:when test="${ rq_acciones == 'save' }">
                                                                <input type="text" name="p_country_name" class="form-control form-control-user"
                                                                       value='<jstl:out value="${ rq_countryName }">Lost Value</jstl:out>' readonly>
                                                                <input type="hidden" name="p_country_number" value='<jstl:out value="${ rq_countryNumber }">Lost Value</jstl:out>'>
                                                            </jstl:when>
                                                            <jstl:otherwise>
                                                                <select name="p_country_number" tabindex="2" class="form-control" id="country">
                                                        ...
                                                        <jstl:choose>
                                                            <jstl:when test="${ rq_acciones == 'save' }">
                                                                <input type="text" name="p_name" class="form-control form-control-user" id="InputName"
                                                                       placeholder="State Name" maxlength="40" value='<jstl:out value="${ rq_stateName }">Lost Value</jstl:out>'>
                                                                <input type="hidden" name="p_state" id="state" value="<jstl:out value="${ rq_stateNumber }">Lost Value</jstl:out>">
                                                            </jstl:when>
                                                            <jstl:otherwise>
                                                                <input type="text" name="p_name" class="form-control form-control-user" id="InputName" placeholder="State Name" maxlength="40">
                                                            </jstl:otherwise>
                                                        </jstl:choose>
