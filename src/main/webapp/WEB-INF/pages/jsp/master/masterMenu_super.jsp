...
<body>
    ...
    <!-- Pre-loader end -->
    <!-- Declaracion de variables jsp -->
    <jstl:set var="jsp_navBarOption" scope="page" value="${ '1,3,5,6' }"/>
    <%--<jstl:set var="jsp_navBarOption" scope="page" value="${ '1,2,3,4,5,6' }"/>--%>
    ...
    <div id="pcoded" class="pcoded">
        ...
        <div class="pcoded-container navbar-wrapper">
            <!-- Empieza Aqui barra delgada verde de arriba -->
            <%@include file="../../../../complements/jsp/header_green_bar.jsp"%>
            <!-- Termina Aqui barra delgada verde de arriba -->
            <div class="pcoded-main-container">
                <div class="pcoded-wrapper">
                    <!--  Empieza Menu del lado izquierdo -->
                    <%@include file="../../../../complements/jsp/left_menu_master.jsp"%>
                    <!--  Termina Menu del lado izquierdo -->
                    <div class="pcoded-content">
                        <!-- Empieza Page-header Segunda linea azul del tope -->
                        <%@include file="../../../../complements/jsp/header_blue_bar.jsp"%>
                        <!-- Termina Page-header Segunda linea azul del tope -->
                        <!-- Start Main-body -->
    ...
    <!-- remocion de variables jsp -->
    <jstl:remove var="jsp_navBarOption" scope="page"/>
    <jstl:remove var="jsp_dashbHome" scope="page"/>
    <jstl:remove var="jsp_dashbName" scope="page"/>
    <jstl:remove var="jsp_dashbMsg1" scope="page"/>
    <jstl:remove var="jsp_dashbBodyMsg" scope="page"/>
    <jstl:remove var="jsp_menuOption" scope="page"/>
    <jstl:remove var="jsp_ShowImage" scope="page"/>
</body>
