...
<head>
    <title>User Projects Files</title>
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        <jstl:when test="${ rq_acciones.equals('consult') }">
            function nuevo_registro(){
                ...
                document.forma.action = '/objectboard/project';
        ...
        <jstl:when test="${ rq_acciones.equals('create') }">
            function nuevo_registro(){
                if (varias_validaciones() &&
                    ...
                    document.forma.target = "";
                    document.forma.action = '/objectboard/projectprocess';
                    document.forma.p_acciones.value = "create";
                    document.forma.submit();
                }
            }
            ...
            function varias_validaciones() {
                if (!valida_textos(document.forma.p_name.value,"Project Name","")||
                    !valida_largos(document.forma.p_name.value.length,"Project Name",2)||
                    !valida_textos(document.forma.p_note.value,"Project Note Note",",.")||
                    !valida_largos(document.forma.p_note.value.length,"Project Note",2)
                ){
                    return false;
                }
                return true;
        ...
        <jstl:when test="${ rq_acciones.equals('save') }">
            ...
            function varias_validaciones() {
                if (!valida_textos(document.forma.p_name.value,"Project Name","")||
                    !valida_largos(document.forma.p_name.value.length,"Project Name",2)||
                    !valida_textos(document.forma.p_note.value,"Project Note",".,")||
                    !valida_largos(document.forma.p_note.value.length,"Project Note",2)
                ){
                    return false;
                }
        ...
        function borrar_registro(){
            if(validaItems(this)){
                if ( confirm("Do You really want to delete the selected Project?")) {
                    document.forma.action = '/objectboard/projectprocess';
        ...
        function validaItems(source) {
            ...
            if(cta==0){
                alert("There are no Projects selected to remove.");
                return false;
            }
            return true;
        }
...
<div id="pcoded" class="pcoded">
    ...
    <div class="pcoded-container navbar-wrapper">
        ...
        <div class="pcoded-main-container">
            <!--start ############################### page-header ###############################-->
            <jstl:set var="jsp_titleFrom" scope="page" value="Projects List Form"/>
                ...
                <form class="user" role="form" method="post" action="#!" name="forma" >
                    <jstl:choose>
                        <jstl:when test="${ rq_acciones.equals('create') }">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    <label for="note" class="col-form-label">Projects Note:</label>
                                </div>
                                <div class="col-sm-4">
                                    <input name="p_note" id="note" maxlength="145" type="text" class="form-control"
                                           onfocus="selecciona_contenido(this)">
                                </div>
                            </div>
                            <hr>
                        ...
                        <jstl:when test="${ rq_acciones.equals('save') }">
                            <div class="form-group row">
                                <div class="col-sm-2">
                                    <label for="name1" class="col-form-label">Projects Name:</label>
                                </div>
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-2">
                                    <label for="note1" class="col-form-label">Projects Note:</label>
                                </div>
                                <div class="col-sm-4">
                                    <input name="p_note" id="note1" maxlength="145" type="text" class="form-control"
                    ...
                    <table id="other" cellspacing="0" width="100%" border="0">
                        ...
                        <jstl:choose>
                            <jstl:when test="${ rq_acciones.equals('consult') }">
                                <tr>
                                    <button type= "button" id="add" title="Create New Project" class= "btn btn-outline-success" onClick=nuevo_registro() ><i class='fa fa-file-o fa-fw'></i> New</button>
                                    &nbsp;
                                    <button type= "button" id="remove" title="Delete Project" class= "btn btn-outline-danger" onClick=borrar_registro() >
                            ...
                            <jstl:when test="${ rq_acciones.equals('create') }">
                                <tr>
                                    <button type= "button" id="add1" title="Create New Project" class= "btn btn-outline-success" onClick=nuevo_registro() >
                                        <i class='fa fa-file-o fa-fw'></i> Create</button>
                                    &nbsp;
                                    <button type= "button" id="remove1" title="Delete Project" class= "btn btn-outline-danger" onClick=borrar_registro() >
                                        <i class='fa fa-trash-o fa-fw'></i> Trash
                                    </button>
                                    &nbsp;
                            ...
                            <jstl:when test="${ rq_acciones.equals('save') }">
                                <tr>
                                    <button type= "button" id="add2" title="Update Projects" class= "btn btn-outline-success" onClick=update_registro() >
                                        <i class='fa fa-file-o fa-fw'></i> Save
                                    </button>
                                    &nbsp;
                                    <button type= "button" id="remove2" title="Delete Projects" class= "btn btn-outline-danger" onClick=borrar_registro() >
                                        <i class='fa fa-trash-o fa-fw'></i> Trash
                                    </button>
                                    &nbsp;
                    ...
                    >
                        ...
                        <tr>
                            ...
                            <th data-field="st" data-sortable="true" data-switchable="true" data-filter-control="input">NOTE</th>
                            ...
                            <jstl:when test="${ rq_numFilas != 0 }">
                                ...
                                <jstl:forEach var="x" begin="0" end="${ rq_provo.size() -1 }" step="1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <jstl:out value="${ rq_provo.get(x).getPrName() }">Lost Value</jstl:out>
                                            <input type='hidden' value='<jstl:out value="${ rq_provo.get(x).getPrName() }"/>'
                                                   name='p_cual_1<jstl:out value="${ f }"/>' id="cual_1" />&nbsp;
                                            <input type='hidden' value='<jstl:out value="${ rq_provo.get(x).getPrIdProject() }"/>'
                                                   name='p_cual_2<jstl:out value="${ f }"/>' id="cual_2" />&nbsp;
                                        </td>
                                        <td>
                                            <jstl:out value="${ rq_provo.get(x).getPrNote() }">Lost Value</jstl:out>
                                        </td>
                                        <td>
                                            <a href='#' title="Edit" onClick=valida(${ rq_provo.get(x).getPrIdProject() })>
                    ...
                    <input name='p_pantalla' type='hidden' value='projects' />
