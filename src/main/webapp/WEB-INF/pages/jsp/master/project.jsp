        ...
        <div class="pcoded-main-container">
            <div class="pcoded-wrapper">
                <div class="pcoded-content">
                    ...
                    <!--start ############################### page-header ###############################-->
                    <jstl:set var="jsp_titleFrom" scope="page" value="Projects form"/>
                                            ...
                                            <div class="container mt-2 mb-2">
                                                ...
                                                <table id="table" class="table table-striped table-bordered mydatatable" style="width :100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th data-field="project" data-sortable="true" data-switchable="true" data-filter-control="input">PROJECT NAME</th>
                                                        <th data-field="description" data-sortable="true" data-switchable="true" data-filter-control="input">DESCRIPTION</th>
                                                    </tr>
                                                    </thead>
                                                    <tbody id="tbody">
                                                    <jstl:forEach varStatus="status" var="projectDto"  items="${ rq_ProjectDto.getProjectDtoSet() }">
                                                        <tr><!--#Start#######################Fila########################-->
                                                            <td style="display: none">
                                                                <input type='checkbox'/></td>
                                                            <td style="display: none"></td>
                                                            <td style="display: none"></td>
                                                            <td><jstl:out value="${ projectDto.prIdProject }">Lost Value</jstl:out></td>
                                                            <td oninput="writeAction(this, 'up');enableButtonSave(true)" id='tdId<jstl:out value="${ status.count }"/>-1'>
                                                                <jstl:out value="${ projectDto.prName }">Lost Value</jstl:out></td>
                                                            <td oninput="writeAction(this, 'up');enableButtonSave(true)" id='tdId<jstl:out value="${ status.count }"/>-2'>
                                                                <jstl:out value="${ projectDto.prNote }">Lost Value</jstl:out></td>
                                                        </tr><!--#End#######################Fila########################-->
