...
<head>
    <title>Organizations Files</title>
    ...
    <script language="JavaScript" type="text/javascript">
        <jstl:choose>
            ...
            document.forma.action = '/objectboard/organizations';
            ...
            <jstl:when test="${ rq_acciones.equals('create') }">
                function nuevo_registro(){
                    if (varias_validaciones() &&
                        ...
                        document.forma.target = "";
                        document.forma.action = '/objectboard/organizationprocess';
                        document.forma.p_acciones.value = "create";
                        document.forma.submit();
                    }
                }
                ...
                function varias_validaciones() {
                    if (!valida_textos(document.forma.p_level1.value,"Organization Level 1","")||
                        !valida_largos(document.forma.p_level1.value.length,"Organization Level 1",2)||
                        !valida_textos(document.forma.p_level2.value,"Organization Level 2","")||
                        !valida_largos(document.forma.p_level2.value.length,"Organization Level 2",2)||
                        !valida_textos(document.forma.p_level3.value,"Organization Level 3","")||
                        !valida_largos(document.forma.p_level3.value.length,"Organization Level 3",2)||
                        !valida_textos(document.forma.p_level4.value,"Organization Level 4","")||
                        !valida_largos(document.forma.p_level4.value.length,"Organization Level 4",2)
                    ){
                        return false;
                    }
                    return true;
                ...
                function valida_duplicados(source) {
                    ...
                    for(i=0;i<checkboxes.length;i++) {//recoremos todos los controles
                        ...
                        if(checkboxes[i].id == "cual_4") {
                            if (checkboxes[i].value == document.forma.p_level4.value) {
                                cta4 = cta4 + 1;
                            }
                        }
                    }
                    if(cta1!=0 && cta2 !=0 && cta3 !=0 && cta4 !=0){
                        alert("The organizational structure that you want to create or modify \nalready exists previously, so the requested changes will NOT be made.");
                        return false;
                    }
                    return true;
                }
        ...
        function borrar_registro(){
            if(validaItems(this)){
                if ( confirm("Do You really want to delete the selected Organizations?")) {
                    document.forma.action = '/objectboard/organizationprocess';
        ...
        function validaItems(source) {
            ...
            if(cta==0){
                alert("There are no organizations selected to remove.");
                return false;
            }
            return true;
        }
        function valida(valor1,valor2,valor3,valor4){
            ...
            document.forma.p_levels4.value = valor4.replace("-"," ");
            document.forma.target = "";
            document.forma.p_acciones.value = "save";
            document.forma.action = "/objectboard/organizations";
            document.forma.submit();
...
<div id="pcoded" class="pcoded">
    ...
    <div class="pcoded-container navbar-wrapper">
        ...
        <div class="pcoded-main-container">
            <!--start ############################### page-header ###############################-->
            <jstl:set var="jsp_titleFrom" scope="page" value="Organizations List Form"/>
                ...
                <form class="user" role="form" method="post" action="#!" name="forma" >
                    <jstl:choose>
                        <jstl:when test="${ rq_acciones.equals('create') }">
                            <div class="form-group row">
                                <div class="col-sm-2">
                                    <label for="level1" class="col-form-label">Organization Level 1:</label>
                                </div>
                                <div class="col-sm-3">
                                    <input name="p_level1" id="level1" maxlength="45" type="text"
                                           class="form-control" onfocus="selecciona_contenido(this)"  >
                                </div>
                                <div class="col-sm-2">
                                    <label for="level2" class="col-form-label">Organization Level 2:</label>
                                </div>
                                <div class="col-sm-3">
                                    <input name="p_level2" id="level2" maxlength="45" type="text"
                                           class="form-control" onfocus="selecciona_contenido(this)"  >
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-2">
                                    <label for="level3" class="col-form-label">Organization Level 3:</label>
                                </div>
                                <div class="col-sm-3">
                                    <input name="p_level3" id="level3" maxlength="45" type="text"
                                           class="form-control" onfocus="selecciona_contenido(this)"  >
                                </div>
                                <div class="col-sm-2">
                                    <label for="level4" class="col-form-label">Organization Level 4:</label>
                                </div>
                                <div class="col-sm-3">
                                    <input name="p_level4" id="level4" maxlength="45" type="text"
                                           class="form-control" onfocus="selecciona_contenido(this)"  >
                                </div>
                            </div>
                            <hr>
                        ...
                        <jstl:when test="${ rq_acciones.equals('save') }">
                            <div class="form-group row">
                                <div class="col-sm-2">
                                    <label for="level11" class="col-form-label">Organization Level 1:</label>
                                </div>
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-2">
                                    <label for="level21" class="col-form-label">Organization Level 2:</label>
                                </div>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-2">
                                    <label for="level31" class="col-form-label">Organization Level 3:</label>
                                </div>
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-2">
                                    <label for="level41" class="col-form-label">Organization Level 4:</label>
                                </div>
                                <div class="col-sm-3">
                                    <input name="p_level4" id="level41" maxlength="45" type="text"
                                           class="form-control" value="${ rq_level4 }" onfocus="selecciona_contenido(this)" >
                                </div>
                            </div>
                            <hr>
                        </jstl:when>
                    ...
                    <table id="other" cellspacing="0" width="100%" border="0">
                        ...
                        <jstl:choose>
                            <jstl:when test="${ rq_acciones.equals('consult') }">
                                <tr>
                                    <button type= "button" id="add" title="Create New Organization" class= "btn btn-outline-success" onClick=nuevo_registro() ><i class='fa fa-file-o fa-fw'></i> New</button>
                                    &nbsp;
                                    <button type= "button" id="remove" title="Delete Organizations" class= "btn btn-outline-danger" onClick=borrar_registro() >
                            ...
                            <jstl:when test="${ rq_acciones.equals('create') }">
                                <tr>
                                    <button type= "button" id="add1" title="Create New Organization" class= "btn btn-outline-success" onClick=nuevo_registro() >
                                        <i class='fa fa-file-o fa-fw'></i> Create</button>
                                    &nbsp;
                                    <button type= "button" id="remove1" title="Delete Organizations" class= "btn btn-outline-danger" onClick=borrar_registro() >
                                        <i class='fa fa-trash-o fa-fw'></i> Trash
                                    </button>
                                    &nbsp;
                            ...
                            <jstl:when test="${ rq_acciones.equals('save') }">
                                <tr>
                                    <button type= "button" id="add2" title="Update Organization" class= "btn btn-outline-success" onClick=update_registro() >
                                        <i class='fa fa-file-o fa-fw'></i> Save</button>
                                    &nbsp;
                                    <button type= "button" id="remove2" title="Delete Organizations" class= "btn btn-outline-danger" onClick=borrar_registro() >
                                        <i class='fa fa-trash-o fa-fw'></i> Trash
                                    </button>
                                    &nbsp;
                    ...
                    >
                        ...
                        <tr>
                            ...
                            <th data-field="l3" data-sortable="false" data-valign="middle" data-align="center">LEVEL4</th>
                            ...
                            <jstl:when test="${ rq_numFilas != 0 }">
                                ...
                                <jstl:forEach var="x" begin="0" end="${ rq_numFilas -1 }" step="1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <jstl:out value="${ rq_orga.get(x).getLevel1() }">Lost Value</jstl:out>
                                            <input type='hidden' value='<jstl:out value="${ rq_orga.get(x).getLevel1() }"/>'
                                                   name='p_cual_1<jstl:out value="${ f }"/>' id="cual_1" />&nbsp;
                                        </td>
                                        <td>
                                            <jstl:out value="${ rq_orga.get(x).getLevel2() }">Lost Value</jstl:out>
                                            <input type='hidden' value='<jstl:out value="${ rq_orga.get(x).getLevel2() }"/>'
                                                   name='p_cual_2<jstl:out value="${ f }"/>' id="cual_2" />&nbsp;
                                        </td>
                                        <td>
                                            <jstl:out value="${ rq_orga.get(x).getLevel3() }">Lost Value</jstl:out>
                                            <input type='hidden' value='<jstl:out value="${ rq_orga.get(x).getLevel3() }"/>'
                                                   name='p_cual_3<jstl:out value="${ f }"/>' id="cual_3" />&nbsp;
                                        </td>
                                        <td>
                                            <jstl:out value="${ rq_orga.get(x).getLevel4() }">Lost Value</jstl:out>
                                            <input type='hidden' value='<jstl:out value="${ rq_orga.get(x).getLevel4() }"/>'
                                                   name='p_cual_4<jstl:out value="${ f }"/>' id="cual_4" />&nbsp;
                                        </td>
                                        <td>
                                            <a href='#' title="Edit" onClick=valida('${ rq_orga.get(x).getLevel1().replace(" ","-") }','${ rq_orga.get(x).getLevel2().replace(" ","-") }','${ rq_orga.get(x).getLevel3().replace(" ","-") }','${ rq_orga.get(x).getLevel4().replace(" ","-") }')>
                    ...
                    <input name='p_levels4' type='hidden' value='${ rq_level4}' />
                    <input name='p_pantalla' type='hidden' value='organization' />
