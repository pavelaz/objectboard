                        ...
                        if (document.forma.p_audi_solu.value === "F"){
                            if (document.forma.p_status_rank.value === "T") {
                                if (!valida_montos(document.forma.p_min.value, "Minimum range value", 0) ||
                                    !valida_montos(document.forma.p_max.value, "Maximum range value", 1)) {
                                    return false;
                                }
                                if (!document.forma.p_max.value > document.forma.p_min.value ||
                                    document.forma.p_max.value === document.forma.p_min.value ||
                                    parseFloat(document.forma.p_max.value) === parseFloat(document.forma.p_min.value)){
                                    alert("For a range the minimum value must always be lower than the maximum value");
                                    return false;
                                }
