...
<footer class="footer">
    <div class="footer__logo-box">
        ...
        <picture class="footer__logo">
            <source srcset="complements/img/logo-green-small-1x1.png 1x, complements/img/logo-green-small-2x1.png 2x"
                    media="(max-width: 37.5em)">
            <!--<img src="<%= request.getContextPath() %>/complements/img/logo-green-1x1.png 1x, complements/img/logo-green-2x1.png 2x" alt="Full logo" src="complements/img/logo-green-2x1.png">-->
        </picture>
