...
import com.psg.objectboard.model.own.ownsEntity.classVO.OtherVO.CommentsTermsVO;

import java.sql.*;
import java.util.ArrayList;

public class CommentsTermsDAO {
    private static OtherConexion cc = null;
    private static CommentsTermsVO covo = null;
    ...
    public static void setDataUser(String dataUser) {
        CommentsTermsDAO.dataUser = dataUser;
    }

    public static void setDataPassword(String dataPassword) {
        CommentsTermsDAO.dataPassword = dataPassword;
    }

    public ArrayList<CommentsTermsVO> getListComments(String condi){
        ArrayList<CommentsTermsVO> arrcom = new ArrayList<CommentsTermsVO>();
